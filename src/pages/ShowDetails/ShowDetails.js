...
const ShowDetails = () => {
  ...
  const url = `https://fullstack-assignment11-server.vercel.app/reviews?serviceName=${service.title}`;
  fetch(url)
    .then((res) => res.json())
  ...
  const handleReview = (e) => {
    ...
    console.log(reviews);
    fetch("https://fullstack-assignment11-server.vercel.app/reviews", {
      method: "POST",
